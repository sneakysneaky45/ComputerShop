...
<html lang="en">
  <head>
    ...
    <link href="meinBereich.css" rel="stylesheet">
	</head>
	  <body>
  ...
  <div class="container d-flex flex-column flex-md-row justify-content-between">
	...
	<a class="py-2 d-none d-md-inline-block" href="../login/login.php">Login</a>
		...
		echo"</li>";
		echo"<li>";
		if(isset($_SESSION['prename'])){
		echo $_SESSION['prename'];
		}
			echo"</li>";
			echo"<li>";
		...
		$rolle = $_SESSION['rolle'];
			if($_SESSION['rolle']=='Admin'){
				echo"<a href='../adminMenu/adminMenu.php'>$rolle</a>";
		}
		else if($_SESSION['rolle']=='Mod'){
			echo"<a href='../adminMenu/adminMenu.php'>$rolle</a>";
		}
		else{
		echo"<a href='meinBereich.php'>$rolle</a>";
		}
		}

			echo"</li>";
			echo"<li>";
			echo"<a href= '../utilities/logoutSkript.php'>Logout</a></li>";
			echo"</ul>";
			}		
			?>		
	</body>
